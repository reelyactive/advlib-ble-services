...
const service = require('../../lib/wiliot.js');
...
const EXPECTED_DATA_VALID_PAYLOAD = {
    relay: {
        type: "wiliot",
        payload: "affd010000930c9f0ca420b52c49cf75e6fcc543db7c87e754c65af075"
    },
...
describe('wiliot', function() {
  ...
  it('should handle no input data', function() {
    assert.deepEqual(service.process(), EXPECTED_DATA_INVALID_PAYLOAD);
  });

  // Test the process function with valid payload data
  it('should handle valid payload data', function() {
    assert.deepEqual(service.process(INPUT_DATA_VALID_PAYLOAD),
  ...
  it('should handle invalid payload data', function() {
    assert.deepEqual(service.process(INPUT_DATA_INVALID_PAYLOAD),
